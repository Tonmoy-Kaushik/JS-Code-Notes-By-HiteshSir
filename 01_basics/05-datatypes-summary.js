...
//In heap, the real value is assigned. eg. let user1 = { name : 'John', age : 24}; let user2 = user1; user2.age = 21; here displaying user2's age will give 21 but user1 will also give the same as it will stay equal to user2 all the time. So changing one will have effect on both objects.
